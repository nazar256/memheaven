...
4. Continue the discoverability campaign at the recorded 24-hour, 72-hour, and 7-day checkpoints; do not change the fixed query set or create duplicate catalog listings. Re-verify Official MCP Registry search propagation for v0.1.2.
